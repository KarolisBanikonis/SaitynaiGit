...
namespace InfoMovies.Migrations
{
    ...
    [Migration("20211102130522_add_userId_to_comment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InfoMovies.Data.Dtos.Auth.InfoMoviesUser", b =>
                {
            ...
            modelBuilder.Entity("InfoMovies.Data.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("InfoMovies.Data.Dtos.Auth.InfoMoviesUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InfoMovies.Data.Dtos.Auth.InfoMoviesUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
